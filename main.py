...
cTime = allCDists()
zTime = allZDists() #ao que tudo indica isso é o método mais rápido, mas como estamos convertendo as zmat em cartesianas (essencialmente) pode ser por conta disso
...
print("=======================END=OF=CODE=======================")
print(f"Time to run all operations in Z-matrices is {zTime} seconds")
print(f"Time to run all operations in C-matrices is {cTime} seconds")
